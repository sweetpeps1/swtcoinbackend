...
firebase_admin.initialize_app(cred, {'storageBucket': 'sweetpeps10.firebasestorage.app'})
db = firestore.client()
bucket = storage.bucket()

def generate_start_keyboard():
    keyboard = InlineKeyboardMarkup()
    keyboard.add(InlineKeyboardButton("Open SwtCoin App", web_app=WebAppInfo(url="https://swt.agency/")))
    return keyboard
